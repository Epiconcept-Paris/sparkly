...
trait Storage {
  ...
  val sparkCanRead:Boolean 
  val isLocal:Boolean 
  val tmpPrefix:String="fr.epiconcept.sparkly_" 
...
case class LocalStorage(override val sparkCanRead:Boolean=false, override val tmpPrefix:String="fr.epiconcept.sparkly_") extends Storage {
...
case class HDFSStorage(hadoopConf:Configuration, override val tmpPrefix:String="fr.epiconcept.sparkly_") extends Storage {
